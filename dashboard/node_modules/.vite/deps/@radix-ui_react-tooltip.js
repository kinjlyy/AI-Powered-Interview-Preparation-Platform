...
function createSlot5(ownerName) {
  ...
  const Slot22 = React17.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime15.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React17.isValidElement(newElement) ? React17.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React22.useRef(true);
  const isPointerInTransitRef = React22.useRef(false);
  ...
  return (0, import_jsx_runtime20.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React22.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React22.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
      ...
      onPointerInTransitChange: React22.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const wasOpenDelayedRef = React22.useRef(false);
  ...
  const stateAttribute = React22.useMemo(() => {
  ...
  return (0, import_jsx_runtime20.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime20.jsx)(
    TooltipContextProvider,
    {
      ...
      onTriggerEnter: React22.useCallback(() => {
...
var TooltipTrigger = React22.forwardRef(
  (props, forwardedRef) => {
    ...
    const handlePointerUp = React22.useCallback(() => isPointerDownRef.current = false, []);
    React22.useEffect(() => {
...
var TooltipContentHoverable = React22.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME2, props.__scopeTooltip);
  const ref = React22.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React22.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React22.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React22.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React22.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
...
var TooltipArrow = React22.forwardRef(
  (props, forwardedRef) => {
